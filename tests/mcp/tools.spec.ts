...
const schemaSamples: Record<string, { valid: unknown; invalid?: unknown }> = {
  ...
  'hol.memory.put': { valid: { key: 'k1', value: { foo: 'bar' }, scope: 's', tags: ['t1'], ttlSeconds: 60 }, invalid: { key: '', value: 'x' } },
  'hol.memory.get': { valid: { key: 'k1', scope: 's' }, invalid: { key: '' } },
  'hol.memory.list': { valid: { scope: 's', tag: 't1', limit: 10 }, invalid: { limit: -1 } },
  'hol.memory.delete': { valid: { key: 'k1', scope: 's' }, invalid: { key: '' } },
  'hol.memory.clear': { valid: { scope: 's' } },
